...
export function ToggleSidebar() {
  ...
  return (
    <button
      ...
      className={`floating-shadow flex cursor-pointer items-center justify-between rounded-lg bg-white p-2 hover:bg-indigo-50 ${sideBarIsOpen ? "-scale-x-100" : ""}`}
    >
      <svg
